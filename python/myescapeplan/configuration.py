...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "BusinessApiKey": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = myescapeplan.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.myescapeplan.app" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("myescapeplan")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'BusinessApiKey' in self.api_key:
            auth['BusinessApiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-KEY',
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://api.myescapeplan.app",

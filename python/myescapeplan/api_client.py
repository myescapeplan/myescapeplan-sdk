...
from myescapeplan.configuration import Configuration
from myescapeplan.api_response import ApiResponse, T as ApiResponseT
import myescapeplan.models
from myescapeplan import rest
from myescapeplan.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(myescapeplan.models, klass)
